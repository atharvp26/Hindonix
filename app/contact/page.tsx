      ...
      <section className="relative pt-32 pb-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="font-heading text-4xl lg:text-5xl font-bold text-white mb-6">Get in Touch</h1>
            <p className="text-lg text-white/80">Have a question about our architectural hardware? We&apos;re here to help.</p>
          </div>
        </div>
      </section>
