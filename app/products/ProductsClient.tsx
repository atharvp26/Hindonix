        ...
        <div className="relative lg:absolute lg:inset-0 flex items-center justify-center pt-24 pb-10 lg:py-0">
          <div className="container mx-auto px-4 lg:px-8 lg:pt-16">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="font-heading text-3xl lg:text-5xl font-bold mb-4" style={{ color: '#ffffff' }}>Architectural Hardware</h1>
              <p className="text-sm lg:text-lg" style={{ color: '#ffffff' }}>Discover our curated collection of precision-crafted door handles and hardware.</p>
            </div>
          </div>
        </div>
      </section>
